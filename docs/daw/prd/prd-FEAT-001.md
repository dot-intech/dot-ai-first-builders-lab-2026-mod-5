...
|---|---|---|---|---|
| FEAT-001a | Acceso directo de QA sin magic link | prd-FEAT-001a.md | none | active |
| FEAT-001b | Registrar consumo a partir de una foto (captura/galería) con análisis de IA | prd-FEAT-001b.md | depends on a | pending |
